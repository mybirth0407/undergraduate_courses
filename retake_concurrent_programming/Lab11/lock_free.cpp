...
#define IS_MARKED(p) ((unsigned long long)p & 0x8000000000000000)
#define MARK(p) ((unsigned long long)p | 0x8000000000000000)
#define UNMARK(p) ((unsigned long long)p & 0x7FFFFFFFFFFFFFFF)
#define ADDRESS(p) (Node *)UNMARK(p)
